...
//         //Verificamos que los campos de texto esten completos: 
//         if (!nombre || !apellido || !telefono || !email || !emailConfirmacion) {
//             setError("Por favor complete todos los campos");
//             return;
//         }

//         //Validamos que los campos del email coinciden:
//         if (email !== emailConfirmacion) {
//             setError("Los campos del email no coinciden");
//             return;
//         }

//         //Paso 1: Crear el objeto de la orden
...
//                 setError("Se produjo un error al crear la orden de compras, vuelva prontus");
//             })
